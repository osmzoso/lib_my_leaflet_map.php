...
class my_leaflet_map
{
   ...
   // attributes (color, opacity, weight, dasharray, fillcolor, fillopacity)
   public $color = '#0000ff';
   public $opacity = 0.5;
   public $weight = 10;
   ...
   function set_properties( $v1, $v2, $v3, $v4, $v5, $v6 ) {
      $this->set_color( $v1 );
      $this->set_opacity( $v2 );
      $this->set_weight( $v3 );
   ...
   function add_marker( $lat, $lon, $marker, $popuptext, $openpopup ) {
